...
<nav>
    ...
    <ul class="subnav">
        ...
        <li <?php if (strpos($_SERVER['REQUEST_URI'], 'thema2.php') !== false) echo 'class="active"'; ?>>
            <a href="./pages/thema2.php">
                <img src="./images/iconen/thema's.svg" alt="Thema's" class="nav-icon" id="icoon-display"> Thema's
            </a>
        </li>
        <li <?php if (strpos($_SERVER['REQUEST_URI'], 'zittingen.php') !== false) echo 'class="active"'; ?>>
            <a href="./pages/zittingen.php">
                <img src="./images/iconen/zittingen.svg" alt="Zittingen" class="nav-icon" id="icoon-display"> Zittingen
            </a>
        </li>
        <li <?php if (strpos($_SERVER['REQUEST_URI'], 'vrijwilligerswerk.php') !== false) echo 'class="active"'; ?>>
            <a href="./pages/vrijwilligerswerk.php">
                <img src="./images/iconen/vrijwilligerswerk.svg" alt="Vrijwilligerswerk" class="nav-icon" id="icoon-display"> Vrijwilligerswerk
            </a>
        </li>
        <li <?php if (strpos($_SERVER['REQUEST_URI'], 'activiteiten.php') !== false) echo 'class="active"'; ?>>
            <a href="./pages/activiteiten.php">
                <img src="./images/iconen/activiteiten.svg" alt="Activiteiten" class="nav-icon" id="icoon-display"> Activiteiten
            </a>
        </li>
        <li>
            <a href="#">
                <img src="./images/iconen/contact.svg" alt="Contact" class="nav-icon" id="icoon-display"> Contact
            </a>
        </li>
        <li>
            <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true): ?>
                <a href="#"  id="icoon-display">
                <img src="./images/iconen/notification.svg" alt="notificatie" class="nav-icon" > Notificatie
                </a>
                </li>
                <li>
                    <a href="#" id="icoon-display">
                        <img src="./images/iconen/profile.svg" alt="Profiel" class="nav-icon" > Account
                        </a>
                        </li>
            <li class="logout-mobile" id="logout">
                <a href="./signin_login_logout/logout.php">
                <a id="logout-mobile" class="logout-button" href="./signin_login_logout/logout.php">Uitloggen</a>
                </a>
            </li>
